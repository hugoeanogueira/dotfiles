...
JDK_25_ARM="/Library/Java/JavaVirtualMachines/temurin-25.jdk/Contents/Home/";
export JAVA_HOME="$JDK_25_ARM";
...
alias jdk25_arm="export JAVA_HOME=$JDK_21_ARM; java -version";
